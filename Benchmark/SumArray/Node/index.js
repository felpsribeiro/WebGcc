...
const Benchmarkify = require("./node_modules/benchmarkify");
const fs = require('fs');
...
// const benchmark = new Benchmarkify("Teste de velocidade").printHeader();
// const bench = benchmark.createSuite("Somador de um array", { time: 20000 });
// bench.ref("Somador em JS", () => {
//     sum(array);
// });
// bench.add("Somador em WA", () => {
//     sumWA(QUANT);
// });
// bench.add("Somador em WA com otimização", () => {
//     sumWAO4(QUANT);
// });
